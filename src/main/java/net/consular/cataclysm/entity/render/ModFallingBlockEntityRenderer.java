...
public class ModFallingBlockEntityRenderer
extends EntityRenderer<ModFallingBlockEntity> {
    ...
    @Override
    public Identifier getTexture(ModFallingBlockEntity fallingBlockEntity) {
