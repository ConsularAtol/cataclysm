...
public enum ModArmorMaterials implements ModArmorMaterial {
    ...
    ANCIENT("ancient", 38, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        map.put(ArmorItem.Type.BOOTS, 3);
        map.put(ArmorItem.Type.LEGGINGS, 6);
        map.put(ArmorItem.Type.CHESTPLATE, 7);
        map.put(ArmorItem.Type.HELMET, 3);
    }), 17, SoundEvents.BLOCK_SCULK_CHARGE, 1F, 0.1F, 1.25F, 0F, 0F, 0F, 0.5F, () -> {
    ...
    QUARTZ("quartz", 8, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        ...
        map.put(ArmorItem.Type.CHESTPLATE, 2);
        map.put(ArmorItem.Type.HELMET, 1);
    }), 18, SoundEvents.BLOCK_WOOL_PLACE, 1F, 0F, 0F, 0F, 0.4F, 0F, 0F, () -> {
    ...
    ECHO("echo", 20, Util.make(new EnumMap(ArmorItem.Type.class), (map) -> {
        ...
        map.put(ArmorItem.Type.CHESTPLATE, 2);
        map.put(ArmorItem.Type.HELMET, 1);
    }), 28, SoundEvents.BLOCK_WOOL_PLACE, 2F, 0F, 0F, 0F, 0.6F, 0F, 0F, () -> {
        return Ingredient.ofItems(new ItemConvertible[]{Items.ECHO_SHARD});
    }),
